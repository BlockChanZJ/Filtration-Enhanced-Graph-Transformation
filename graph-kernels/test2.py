...
if __name__ == '__main__':
    ...
    kernel_method = {
        ...
        'NH':grakel.NeighborhoodHash(normalize=False),
        'PM':grakel.PyramidMatch(normalize=False),
        # 'GH':grakel.GraphHopper(normalize=False),
        # 'NSPD':grakel.NeighborhoodSubgraphPairwiseDistance(normalize=False),
    }
